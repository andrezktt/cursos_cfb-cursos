...
const abaRetratil = document.querySelector("#aba_retratil")
...
abaRetratil.addEventListener("click", (evento) => {
    calculadora.classList.toggle("calculadora_exibir")
    if (calculadora.classList.contains("calculadora_exibir")) {
        evento.target.setAttribute("src", "arrow_left.svg")
    } else {
        evento.target.setAttribute("src", "arrow_right.svg")
    }
})